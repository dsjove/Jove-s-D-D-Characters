...
public struct Advancement: Codable, Sendable, EmptyCheckable, InvariantCheckable {
	...
	public let currentExperience: Int? // A+S/G ? — updated as advancement is awarded; range: 0... when set
	...
	public var isEmpty: Bool {
		method == nil && currentExperience == nil && nextLevelExperience == nil && milestoneProgress.isEmpty && feats.isEmpty && abilityScoreImprovements.isEmpty && notes.isEmpty
	}

	public func invariant() throws {
		if let currentExperience { try require(currentExperience >= 0, \Self.currentExperience, "must be at least 0") }
