...
public struct Equipment: Codable, Sendable, EmptyCheckable, InvariantCheckable {
	...
	public init(
		...
		self.quantity = max(quantity ?? (name.isEmpty ? 0 : 1), 0)
	...
	public var isEmpty: Bool {
		name.isEmpty && location == .carried && quantity == 0 && unitWeight == nil && armorContribution == nil && attunement == .notRequired && charges.isEmpty && isConsumable == nil && notes.isEmpty
	}
